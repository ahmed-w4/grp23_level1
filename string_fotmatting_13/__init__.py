...
print('Client has id =' + str(client_id) + ', his name is ' + client_name + ', his invoice value = ' + str(client_invoice))


print('------ 2- print with multi parameters --------')

print('Client has id =', client_id, ', his name is ', client_name,  ',\nhis invoice value =', client_invoice)
